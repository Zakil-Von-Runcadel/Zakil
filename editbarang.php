...
<body>
    <h2><center>editdatabarang</center></h2>
    <hr>
    <?php
    $kd_barang = $_GET['id'];
    ...
    ?>
    <form action='aksieditbarang.php?id=<?php echo $data["kd_barang"]; ?>' method='POST'>
        <table border="0">
            <tr>
                <td>kode barang</td>
            ...
            <tr>
                <td>stok</td>
                <td><input name='stok' type='text' id="stok"
                    value="<?php echo $data['stok'] ?>"></td>
            </tr>
        </table>
